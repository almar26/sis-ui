                ...
                <v-card-text>
                  <div class="mx-5 pb-9 pt-3">
                    ...
                    <v-row><v-col cols="12" md="4">
                        <v-text-field color="primary" variant="outlined" label="Last Name" hide-details="auto" readonly
                          :model-value="studentDetails.last_name"></v-text-field>
                      </v-col>
                      <v-col cols="12" md="4">
    ...
    <v-dialog v-model="updateInfoDialog" width="auto" scrollable>
      <v-card prepend-icon="mdi-account" title="Update Personal Information">
            ...
            <v-row dense v-if="studentDetails.major != ''">
              ...
              <v-col cols="12" md="4" sm="6">
                <v-select color="primary" :items="courses" item-title="code" item-value="code" label="Course*"
                  v-model="course" :rules="rules.course" variant="outlined" return-object disabled required></v-select>
              </v-col>
              <v-col cols="12" md="4">
        ...
        <v-card-actions class="my-2">
          ...
          <v-btn color="green" text="Update" prepend-icon="mdi-pencil" variant="tonal" @click="updateDetails()"></v-btn>
          <v-spacer></v-spacer>
        </v-card-actions>
      </v-card>
    </v-dialog>
