          ...
          <v-card>
            <v-card-text>
              <div class="mx-auto text-center">
                ...
                <v-btn prepend-icon="mdi-pencil" variant="text" class="text-capitalize" rounded> Edit Account </v-btn>
                <v-divider class="my-3"></v-divider>
                <v-btn prepend-icon="mdi-logout" variant="text" class="text-capitalize" rounded @click="logout()"> Logout </v-btn>
              </div>
            </v-card-text>
          </v-card>
        </v-menu>
